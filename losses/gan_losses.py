...
class GeneratorLoss(keras.losses.Loss):
    def __init__(self, reduction=keras.losses.Reduction.SUM_OVER_BATCH_SIZE, name='gen_loss'):
...
class DiscriminatorLoss(keras.losses.Loss):
    def __init__(self, reduction=keras.losses.Reduction.SUM_OVER_BATCH_SIZE, name='disc_loss'):
        super().__init__(reduction=reduction, name=name)
